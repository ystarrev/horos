...
# Newer AppleClang warns on GDCM's raw memcpy usage for legacy value types.
# This is third-party code and the warning is noisy but not actionable here.
cxxfs+=( -Wno-nontrivial-memcall )
